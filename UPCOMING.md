...
**Markstream** (web: [markstream.simonhe.me](https://markstream.simonhe.me/), github: [Simon-He95/markstream-vue](https://github.com/Simon-He95/markstream-vue), npm: [markstream-vue](https://www.npmjs.com/package/markstream-vue)) Multi-framework streaming Markdown renderers for AI chat interfaces. Handles incomplete Markdown as tokens arrive and includes Mermaid, KaTeX, Shiki and Monaco code blocks, safe HTML, SSR, and packages for Vue, React, Svelte, and Angular. Open source under the MIT license.
